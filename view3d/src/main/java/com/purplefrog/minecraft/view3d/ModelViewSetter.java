 ...
 */
public abstract class ModelViewSetter
{

    public abstract void invoke(GL2 gl2);
    ...
    */
        ...
        extends ModelViewSetter
    {
        ...
        public LookAt(double cx, double cy, double cz, double pitch, double camx, double camy, double camz, double periodSeconds)
        {
            this.pitch = pitch;
            this.cx = cx;
            this.cy = cy;

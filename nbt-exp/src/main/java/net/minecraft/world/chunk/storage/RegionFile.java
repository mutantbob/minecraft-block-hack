...
//    }
     ...
     */
    public synchronized void write(int subX, int subZ, byte[] payload, int nBytes)
    {
        try
        {
            int l = this.getOffset(subX, subZ);
            int i1 = l >> 8;
            int j1 = l & 255;
            int k1 = (nBytes + 5) / 4096 + 1;
            ...
            else
            {
                ...
                {
                    i1 = l1;
                    this.setOffset(subX, subZ, l1 << 8 | k1);
                ...
                else
                {
                    ...
                    this.write(i1, payload, nBytes);
                    this.setOffset(subX, subZ, i1 << 8 | k1);
                }
            }

            this.setChunkTimestamp(subX, subZ, (int)(System.currentTimeMillis() / 1000L));
        }
        catch (IOException ioexception)
        {
            ioexception.printStackTrace();
